...
/**
* @padrao AlwaysDown
* Usado para criar um incremento que é sempre negativo.
* Esse padrão vai sempre descer o "valor atual" do campo, até que chegue na última amostra(ou na amostra definida pelo usuario em range.endIndex), quando a função para de inserir o padrão
*
* @example
* Exemplo de uso:
*
*   dataset.AddLinearStandart('idade', Analise.LinearStandarts.AlwaysDown({}) );
*/
Analise.DataStructure.LinearStandarts.AlwaysDown = function( detalhes={} ){
    ...
    const detalhesPadrao = {
        ...
        */
        sense: {
            ...
            * Define a codição de subida 
            */
			downCondition: function( parametros ){
                return true; // Vai sempre subir
            }
